                                    ...
                                    <span class="top-left-controls inline-flex flex-1 items-center rounded-lg bg-slate-800/45 px-2 py-[2px] text-slate-100 font-mono text-sm min-w-0">
                                        ...
                                        <span class="inline-flex flex-1 items-center justify-center ml-4 gap-3">
                                            ...
                                            <span class="h-12 px-1.5 rounded-full inline-flex items-center gap-1 bg-slate-800/55 border border-slate-500/45">
                                                <button class={desktopControlInnerBtnClass} onclick={onDesktopStepBackward} aria-label="Step backward"><i class="fa-solid fa-backward-step text-[17px]"></i></button>
                                                <button class={desktopControlInnerBtnClass} onclick={onDesktopStepForward} aria-label="Step forward"><i class="fa-solid fa-forward-step text-[17px]"></i></button>
                                            </span>
