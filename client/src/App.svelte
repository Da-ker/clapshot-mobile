...
<main>
    ...
    <div class="safe-area-pad box-border flex flex-col bg-[#101016] w-full h-[100dvh] overflow-hidden {debugLayout?'border-2 border-yellow-300':''}">
        ...
        <div class="relative h-full min-h-0 overflow-hidden">
            ...
            <div bind:this={commentInputDockEl} class="fixed md:static left-1/2 -translate-x-1/2 md:translate-x-0 md:translate-y-0 w-[calc(100%-1rem)] max-w-[1400px] md:w-auto md:max-w-none md:left-auto md:right-auto bottom-[-12px] md:bottom-auto z-40 px-2 pt-0 pb-2 rounded-t-xl md:rounded-none bg-[#0f1728]/92 backdrop-blur-md shadow-[0_-10px_24px_rgba(0,0,0,0.28)] md:shadow-none">
