...
<main>
    ...
    <div class="safe-area-pad box-border flex flex-col bg-[#101016] w-full h-[100dvh] overflow-hidden {debugLayout?'border-2 border-yellow-300':''}">
        ...
        <div class="relative h-full min-h-0 overflow-hidden">
            ...
            <div
                class="relative md:absolute z-20 left-1/2 -translate-x-1/2 md:translate-x-0 w-[calc(100%-1rem)] max-w-[1400px] md:w-[26rem] md:max-w-none md:left-auto md:right-4 mt-2 md:mt-0 bottom-auto md:bottom-[max(0.5rem,env(safe-area-inset-bottom))] h-[calc(min(44dvh,var(--mobile-comment-max-h))+16px)] max-h-[calc(min(44dvh,var(--mobile-comment-max-h))+16px)] md:h-auto md:max-h-none flex flex-col overflow-hidden rounded-t-2xl md:rounded-xl bg-[#0f1728]/88 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.38)] border-b-4 border-red-500 transition-all duration-200 md:mb-0 {commentsPanelOpen ? 'md:translate-y-0 md:opacity-100' : 'md:translate-y-6 md:opacity-0 md:pointer-events-none'} {commentsPanelMode === 'full' ? 'md:max-h-[85vh]' : ''}"
                style="--mobile-comment-input-h: {mobileCommentInputHeight}px; --mobile-comment-max-h: calc(100dvh - var(--mobile-comment-input-h,88px) - env(safe-area-inset-bottom) - 0.75rem); height: min(44dvh, calc(var(--mobile-comment-max-h) + (var(--mobile-comment-input-h,88px) * 0.5))); max-height: min(44dvh, calc(var(--mobile-comment-max-h) + (var(--mobile-comment-input-h,88px) * 0.5)));"
            >
                ...
                <div data-comments-scroll="1" class="{commentsPanelMode === 'full' ? 'max-h-[74vh]' : 'max-h-[44vh]'} md:max-h-[52vh] overflow-y-auto overflow-x-hidden px-1 py-2 pb-2 md:pb-2 space-y-2 [contain:layout_paint]">
            ...
            <div bind:this={commentInputDockEl} class="fixed md:static left-1/2 -translate-x-1/2 md:translate-x-0 md:translate-y-0 w-[calc(100%-1rem)] max-w-[1400px] md:w-auto md:max-w-none md:left-auto md:right-auto bottom-[-12px] md:bottom-auto z-40 px-2 pt-0 pb-2 rounded-t-xl md:rounded-none bg-[#0f1728]/92 backdrop-blur-md shadow-[0_-10px_24px_rgba(0,0,0,0.28)] border-t-4 border-emerald-400 md:shadow-none">
